    ...
    def __init__(self,
        ...
        with tf.variable_scope('cf_search', reuse=tf.AUTO_REUSE):
            ...
            if distance_fn == 'l1':
                ...
                self.sliding_ts1 = sliding_window_view(val, window_shape=len_shapelet1, axis=1)
                ...
                self.dis_shape1 = tf.reduce_min(tf.math.reduce_sum(tf.abs(self.sliding_ts1 - shapelet1.reshape(-1)), 3), name='l1')
                self.dis_shape1 = tf.cast(self.dis_shape1, tf.float32)
