...
# from utils.defaults import DEFAULT_DATA_CF, DEFAULT_META_CF
# from utils.interfaces import Explainer, Explanation
    ...
    def __init__(self,
        ...
        with tf.variable_scope('cf_search', reuse=tf.AUTO_REUSE):
            ...
            if not self.model:
                ...
                self.loss_opt =  self.loss_dist + self.loss_pred
            ...
            for l_step in range(self.max_lam_steps):
                ...
                for i in range(self.max_iter):
                    ...
                    if(i==0 and l_step==0):
                        ...
                        idx_start, idx_end = getprominentsegment(l, CF_seg_len)
                ...
                print(cf_label)
                flip = (cf_label == self.target_classid)
                print("flip: ", flip)
