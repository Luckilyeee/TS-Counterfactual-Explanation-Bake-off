...
import shortuuid
from nte.models.saliency_model.counterfactual_infocels import CFExplainer
import random
...
if __name__ == '__main__':
    ...
    res_path = f"InfoCELS/{args.dataset}/"
    ...
    for ind, (original_signal, original_label) in ds: #original_signal is from the test set
        try:
            ...
            pert_res = softmax_fn(model(perturbation_res.reshape(1, 1, perturbation_res.shape[1]))) #infocels
    ...
    csv_path = 'InfoCELS/flip_rates.csv'
